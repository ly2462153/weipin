<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPopOrderCheck.aspx.cs"
    Inherits="weipin.LoginPopOrderCheck" %>
...
<head runat="server">
    ...
    <title></title>
    <link href="css/loginpopordercheck.css" rel="stylesheet" type="text/css" />
    ...
    <script src="js/loginpopordercheck.js" type="text/javascript"></script>
</head>
<body>
    <div class="openbox_tab"><span class="openbox_tab01">登录</span><span class="openbox_tab02">
        <a href="/Register.aspx?returnurl=OrderCheck.aspx" target="_parent">注册</a></span></div>
    ...
    <div class="but_div">
        <ul>
            ...
            <li>新用户？<a href="/Register.aspx?returnurl=OrderCheck.aspx" target="_parent">立即注册</a></li>
        </ul>
        <div class="clear"></div>
    </div>
