<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CouriersAdd.aspx.cs" Inherits="weipin.admin.CouriersAdd" %>
...
<head runat="server">
    ...
    <title>快递员添加</title>
    <link href="css/courieradd.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <div id="main">
        <uc1:headadmin ID="headadmin1" runat="server" />
        <script src="../js/jQuery/jquery.validate.min.js" type="text/javascript"></script>
        <script src="js/couriersadd.js" type="text/javascript"></script>
        <div id="cols" class="box">
            <div id="aside" class="box">
                ...
                <ul class="box"><li id="submenu-active"><a href="CouriersAdd.aspx">快递员添加</a></li> <li>
                    ...
                    <table class="nostyle" style="width: 100%;">
                        ...
                        <tr>
                            <td class="tdL">快递员姓名: </td><td>
                                <input type="text" id="txtCourierName" name="txtCourierName" class="input-text" maxlength="5" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="tdL">手机: </td><td>
                                <input type="text" id="txtMobilePhone" name="txtMobilePhone" class="input-text" maxlength="12" />
                            </td>
                        </tr>
                        <tr>
