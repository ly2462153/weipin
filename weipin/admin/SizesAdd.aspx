<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SizesAdd.aspx.cs" Inherits="weipin.admin.SizesAdd" %>
...
<head runat="server">
    ...
    <title>尺码添加</title>
    <link href="css/sizesadd.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <div id="main">
        <uc1:headadmin ID="headadmin1" runat="server" />
        <script src="../js/jQuery/jquery.validate.min.js" type="text/javascript"></script>
        <script src="js/sizesadd.js" type="text/javascript"></script>
        <div id="cols" class="box">
            <div id="aside" class="box">
                ...
                <ul class="box">
                    ...
                    <li id="submenu-active"><a href="SizesAdd.aspx">尺码添加</a></li>
                ...
                <fieldset>
                    ...
                    <table class="nostyle" style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <input type="text" id="txtSizeName" name="txtSizeName" class="input-text" maxlength="20" />
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
