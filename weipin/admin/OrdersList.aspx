<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdersList.aspx.cs" Inherits="weipin.admin.OrdersList" %>
...
<title>订单列表</title>
<link href="css/orderslist.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="main">
<uc1:headadmin ID="headadmin1" runat="server" />
<script src="/js/jquery/jquery.cookie.min.js" type="text/javascript"></script>
<script src="js/orderslist.js" type="text/javascript"></script>
...
<ul class="box"><li id="submenu-active"><a href="OrdersList.aspx">订单列表</a></li> <li>
...
<asp:Repeater ID="rptOrdersList" runat="server" OnPreRender="rptOrdersList_PreRender">
<HeaderTemplate>
...
<%#DataBinder.Eval(Container.DataItem, "OrderID")%></td><td name='tdOID<%#DataBinder.Eval(Container.DataItem, "OrderID")%>'>
<%#DataBinder.Eval(Container.DataItem, "GoodsID")%><input type="hidden" value='<%#DataBinder.Eval(Container.DataItem, "OrdersGoodsID")%>' />
</td><td><a href='/page/<%# Convert.ToInt32(DataBinder.Eval(Container.DataItem, "GoodsID"))/1000%>/goodsshow_<%#DataBinder.Eval(Container.DataItem, "GoodsID")%>.html'
...
<%#DataBinder.Eval(Container.DataItem, "GoodsCount")%></td><td style="word-break:break-all;">
...
</td><td id="tdCourierID" runat="server" style="text-align: left; padding-left: 10px;">
...
出库</a></td><td id="tdOrdersPrint" runat="server"><a href='OrdersPrint.aspx?oid=<%#DataBinder.Eval(Container.DataItem, "OrderID")%>'
