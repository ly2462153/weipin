<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdersRemarksAdd.aspx.cs"
    Inherits="weipin.admin.OrdersRemarksAdd" %>
...
<head runat="server">
    ...
    <title>订单备注添加</title>
    <link href="css/ordersremarksadd.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <div id="main">
        ...
        <script src="js/ordersremarksadd.js" type="text/javascript"></script>
        <div id="cols" class="box">
            <div id="aside" class="box">
                ...
                <ul class="box">
                    ...
                    <li id="submenu-active"><a href="OrdersRemarksAdd.aspx">订单备注添加</a></li>
            ...
            <div id="content" class="box">
                ...
                <fieldset>
                    ...
                    <table class="nostyle" style="width: 100%;">
                        <tr>
                            <td class="tdL">商品号码:</td>
                            <td>
                                <input type="text" id="txtGoodsID" name="txtGoodsID" class="input-text" /><input
                                    type="hidden" id="hidTransactionPrice" name="hidTransactionPrice" />
                            </td>
                            <td class="tdL">用户名:</td>
                            <td>
                                <input type="text" id="txtLoginID" name="txtLoginID" class="input-text" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdL">商品名称:</td>
                            <td>
                                <label id="lblGoodsName"></label>
                            </td>
                            <td class="tdL">快递员:</td>
                            <td>
