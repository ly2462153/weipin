<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdersReturnGoodsList.aspx.cs"
Inherits="weipin.admin.OrdersReturnGoodsList" %>
...
<title>退货列表</title>
<link href="css/ordersreturngoodslist.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="main">
<uc1:headadmin ID="headadmin1" runat="server" />
<script src="../js/jquery/jquery.cookie.min.js" type="text/javascript"></script>
<script src="js/ordersreturngoodslist.js" type="text/javascript"></script>
...
<li id="submenu-active"><a href="OrdersReturnGoodsList.aspx">退货列表</a></li>
...
<h1>退货列表</h1>
<div>
<div id="divOrdersCountStatistics" runat="server"></div>
...
<div id="divShowDataCount" runat="server" style="padding-top: 10px">查询到订单：<span id="spDataCount"
runat="server" style="color: #ff6600;"></span>条</div>
<asp:Repeater ID="rptOrdersReturnGoodsList" runat="server" OnPreRender="rptOrdersReturnGoodsList_PreRender">
<HeaderTemplate>
...
<tr>
<td>
<img src='<%#DataBinder.Eval(Container.DataItem,"GoodsPicturePath") %>' /></td>
...
<td>
<%#DataBinder.Eval(Container.DataItem, "ConsigneeName")%></td>
<td id="ShippingAddress" runat="server">
<%#DataBinder.Eval(Container.DataItem, "ShippingAddress")%></td>
<td>
<%#DataBinder.Eval(Container.DataItem, "MobilePhone")%></td>
<td>
<%#DataBinder.Eval(Container.DataItem, "TelePhone")%></td>
<td>
...
<td name='tdOID<%#DataBinder.Eval(Container.DataItem, "OrderID")%>'>
...
<td>
<%#DataBinder.Eval(Container.DataItem, "TransactionPrice")%>
</td>
<td>
...
<td id='tdGoodsCount<%#DataBinder.Eval(Container.DataItem, "OrdersGoodsID")%>' style="color:#ff0000; font-weight:bold;">
...
<td>
<%#DataBinder.Eval(Container.DataItem, "ExchangeReturnReasons")%></td>
<td id="tdCourierID" runat="server" style="text-align: left; padding-left: 10px;">
<select id='sel<%#DataBinder.Eval(Container.DataItem, "OrderID")%>'>
</select></td>
<td id='tdExtractGoods' runat="server"><a href="#" onclick="ExtractGoods('<%#DataBinder.Eval(Container.DataItem, "OrderID")%>',$(this).parent().attr('id'));return false;">
取货</a></td>
</tr>
</ItemTemplate>
<FooterTemplate>
