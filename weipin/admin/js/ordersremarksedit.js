...
if($(this).find("CourierID").text()==_courierid) { _areacourier+="<option value=\""+$(this).find("CourierID").text()+"\" selected=selected>"+$(this).find("CourierName").text()+"</option>"; }
else { _areacourier+="<option value=\""+$(this).find("CourierID").text()+"\">"+$(this).find("CourierName").text()+"</option>"; }
});
